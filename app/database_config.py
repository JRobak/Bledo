...
def create_tables():
    ...
    cursor.execute('''CREATE TABLE IF NOT EXISTS access_projects (id INTEGER PRIMARY KEY, project_id INTEGER, user_id INTEGER, description TEXT, FOREIGN KEY (user_id) REFERENCES users(id), FOREIGN KEY (project_id) REFERENCES projects(id))''')
